...
def compute_stat_dnn_parallel(feed_forward_nnet,
    ...
    :return: a StatServer...
    """
    FfNn = sidekit.nnet.FForwardNetwork(feed_forward_nnet)
...
def compute_ubm_dnn(self,
    ...
    for idx, seg in enumerate(training_list):
        ...
        features, labels = dnn_features_server.load(seg)
        s0 = forward(features.astype(numpy.float32))[labels]
        ...
        # Get features to compute the statistics
        stat_features = features_server.load(seg)[0]
